...
export default function FeaturedCards({ cards, title, subtitle }: FeaturedCardsProps): JSX.Element | null {
    ...
    <div className="featured-section">
      ...
      <div className="featured-cards-grid">
        {cards.map((card) => (
          ...
          >
            <div className="featured-card-icon" style={{ backgroundColor: `${card.color}15` }}>
              {icons[card.icon] || icons.star}
            </div>
            <h3 className="featured-card-title">{card.title}</h3>
            <div className="featured-card-divider" />
            <p className="featured-card-label">{card.title}</p>
            <p className="featured-card-description">{card.description}</p>
          </a>
        ))}
      </div>
    </div>
